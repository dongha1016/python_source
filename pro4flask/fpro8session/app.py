# 파이썬 세션(session)은 웹에서 정보를 서버를 저장하는 기능을 말함
# 쿠키를 통해 세션을 운영
# 일정 시간동안 동일 사용자(브라우저)와 일련의 요청을 하나의 상태로 보고
# 그 상태를 유지시키는 기술
# 쿠키에 비해 상대적으로 안전함
...
app.secret_key = "abcded123456"     # 위조 방지용 비밀키값
# 참고 키값 자동생성은 터미날 창에서 
# > python -c "import secrets; print(secrets.token_hex(32))"
# e35f802720db297af6bdd96849bc1a7c61dba3f0cdddea9331ecacd171a9ee5a

app.permanent_session_lifetime = timedelta(seconds=5) # 세션 만료 시간 5초설정
