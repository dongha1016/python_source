...
# render_template_string : s문자열로 작성한 jinja템플릿을 렌더링 해 HTML로 반환
# request : 클라이언트가 보낸 값 꺼내기
# make_response	: 쿠키 설정, 상태 코드 변경 등 세밀한 응답 조작
# redirect : 다른 주소로 튕겨내기 (이동시키기)
...
def delete_cookie(): 
    # 쿠키 삭제 후 홈으로 이동하기 위한 redirect 응답을 만들기
