...
print("추가 문제 1번")
a = np.array([[1], [2], [3]])   # 3행 1열
b = np.array([10, 20, 30])      # 1행 3열
print(a*b)
x = a * b
y = x[x >= 30]
print(y)
...
data = np.random.normal(loc=50, scale=10, size=1000)   # loc 평균, scale 표준편차, size = 표본
print(data)
